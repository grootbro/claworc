name: RaveFox Lead Registry
description: Use when a RaveFox lead reaches handoff readiness and should be recorded in the native workspace lead database with a stable numbered ID.
---

# RaveFox Lead Registry
...
3. If not, issue the next `RF-XXXX`.
4. Write or update:
   - `leads/registry.jsonl`
   - `leads/cards/RF-XXXX.md`
...
- If the same contact explicitly opens a different deal or workstream, create a new lead instead of silently merging it.
