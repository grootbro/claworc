---
name: Shirokov Lead Registry
description: Use when a Shirokov Capital lead reaches handoff readiness and should be recorded in the native workspace lead database with a stable numbered ID.
---

# Shirokov Lead Registry
...
3. If not, issue the next `SC-XXXX`.
4. Write or update:
   - `leads/registry.jsonl`
   - `leads/cards/SC-XXXX.md`
